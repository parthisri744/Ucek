...
$examfees = mysqli_real_escape_string($link, $_REQUEST['examfees']);
$dob = mysqli_real_escape_string($link, $_REQUEST['dob']);
$sql = "INSERT INTO examfees (name, regno, contect, email, examfees, dob) VALUES ('$name', '$regno', '$contect', '$email', '$examfees', '$dob')";
  ...
  margin-top:-20px;
    ...
    <body>
          ...
          <fieldset>
            ...
            <label>Exam Fees: </label> <p><?php echo $_POST["examfees"]; ?></p><br>
