...
input[type=text], input[type=tel] , input[type=email], input[type=date],select {
    ...
    <body>
        ...
        <div class="container">
        <form name="form" action="hostelfees.php" method="post"  onsubmit="return checkform(this);" >
          <fieldset>
            ...
            <input type="text"  name="hostelfee" placeholder="Your Amount " maxlength="6" autocomplete="off"   required >
