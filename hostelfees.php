...
$hostelfee = mysqli_real_escape_string($link, $_REQUEST['hostelfee']);
$dob = mysqli_real_escape_string($link, $_REQUEST['dob']);
$sql = "INSERT INTO hostelfees (name, regno, contect, email, hostelfees, dob) VALUES ('$name', '$regno', '$contect', '$email', '$hostelfee', '$dob')";
...
p {
  ...
  margin-top:-20px;
    ...
    <body>
          ...
          <fieldset>
            <legend>Hostel Fees payment</legend>
            ...
            <label>Hostel Fees: </label> <p><?php echo $_POST["hostelfee"]; ?></p><br>
