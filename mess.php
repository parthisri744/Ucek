...
input[type=text], input[type=tel] , input[type=email], input[type=date],select {
    ...
    <body>
        ...
        <div class="container">
        <form name="form" action="messfee.php" method="post"   onsubmit="return checkform(this);" >
          <fieldset>
            ...
            <input type="text"  name="name" onfocus="clear" placeholder="Your name.." autocomplete="off" required>
            ...
            <input type="text"  name="messfees" placeholder="Your Amount " maxlength="6"  autocomplete="off" required >
